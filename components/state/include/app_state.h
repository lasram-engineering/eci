...
#define APP_STATE_ERROR_IOTA_OFFLINE BIT2
#define APP_STATE_ERROR_IOTA_ERROR BIT3
#define APP_STATE_ERROR_IOTA_DEVICE_NOT_REGISTERED BIT4
#define APP_STATE_ERROR_MAU_NOT_AVAIL BIT5
