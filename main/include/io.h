...
#define IO_OUTPUT0 34
#define IO_OUTPUT1 35
#define IO_OUTPUT2 32
#define IO_OUTPUT3 33

#define IO_OUTPUT_NUMBER 4

static const int map_input_to_port[IO_INPUT_NUMBER] = {IO_INPUT0, IO_INPUT1, IO_INPUT2, IO_INPUT3};
static const int map_output_to_port[IO_OUTPUT_NUMBER] = {IO_INPUT0, IO_INPUT1, IO_INPUT2, IO_INPUT3};
